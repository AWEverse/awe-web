...
const SortActions: FC<OwnProps> = props => {
  ...
  return (
    <DropdownMenu className={className} position="top-right" triggerButton={TriggerButton}>
      ...
      <ActionButton className={s.menuItem} icon={renderIcon()} onClick={handleOrderChange}>
        Set order: {order}
      </ActionButton>
    </DropdownMenu>
  );

...
const SettingsNavigation = forwardRef<HTMLDivElement, OwnProps>((props, ref) => {
  ...
  return (
    <>
      <div ref={ref} className={buildClassName(className, s.SettingsNavigationScreen)}>
        <HeaderNavigation
        ...
        >
          ...
          <IconButton size="medium" title="Выйти из аккаунта" onClick={handleOpenExitAccountModal}>
            <ExitToApp />
          </IconButton>
        </HeaderNavigation>
        ...
        <section className={s.SettingSection}>
          ...
          >
            <p>{formatMessage({ id: 'left.settings.account.description' })}</p>
          </SettingsButton>
          ...
          <SettingsButton
            ...
            onClick={() => onScreenChange?.(SettingsScreenType.Personalization)}
          >
            • Стикеры и эмодзи <br />
          </SettingsButton>
        </section>
        ...
        <section className={s.SettingSection}>
          ...
          />
          <p>
            Included with your recent all device purchase. Must be accepted within 90 days of
            activation.
          </p>
        </section>
      </div>

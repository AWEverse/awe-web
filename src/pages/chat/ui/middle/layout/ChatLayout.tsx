...
const Main: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <section ref={mainRef} className={s.Body} role="region" aria-label="Chat main content">
      {children}
    </section>
  );
};
...
const MainContainer: FC<PropsWithChildren> = ({ children }) => {
  return (
    <section aria-label="Chat scrollable content" className={s.MainContainer} role="region">
      {children}
    </section>
  );
};

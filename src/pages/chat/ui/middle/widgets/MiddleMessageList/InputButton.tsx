  ...
  return (
    <section className={s.InputButton}>
      <DropdownMenu position="bottom-right" triggerButton={TriggerButton}>
        ...
        porro quibusdam magnam facere. Sunt dolorum laborum sit molestiae
        voluptates similique eos nihil vero aperiam, mollitia quasi quod iure
        aut accusamus?
      </DropdownMenu>

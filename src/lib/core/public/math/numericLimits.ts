...
export const MAX_DBL: number = Number.MAX_VALUE;
...
export const NumericLimitsUint8 = new NumericLimitsBase<number>(
  MIN_UINT8,
  MAX_UINT8,
);
export const NumericLimitsUint16 = new NumericLimitsBase<number>(
  MIN_UINT16,
  MAX_UINT16,
);
export const NumericLimitsUint32 = new NumericLimitsBase<number>(
  MIN_UINT32,
  MAX_UINT32,
);
export const NumericLimitsUint64 = new NumericLimitsBase<bigint>(
  MIN_UINT64,
  MAX_UINT64,
);
export const NumericLimitsInt8 = new NumericLimitsBase<number>(
  MIN_INT8,
  MAX_INT8,
);
export const NumericLimitsInt16 = new NumericLimitsBase<number>(
  MIN_INT16,
  MAX_INT16,
);
export const NumericLimitsInt32 = new NumericLimitsBase<number>(
  MIN_INT32,
  MAX_INT32,
);
export const NumericLimitsInt64 = new NumericLimitsBase<bigint>(
  MIN_INT64,
  MAX_INT64,
);
export const NumericLimitsFloat = new NumericLimitsBase<number>(
  MIN_FLT,
  MAX_FLT,
  -MAX_FLT,
);
export const NumericLimitsDouble = new NumericLimitsBase<number>(
  MIN_DBL,
  MAX_DBL,
  -MAX_DBL,
);

...
const TrackNavigation: FC<OwnProps> = ({ count, index, visible = 4, size = 'small' }) => {
...
function calculateMarkup(count: number, index: number, visible: number) {
  ...
  const trackTranslateY = getTrackTranslateY(reverseIndex, count, visible, barHeight, trackHeight);

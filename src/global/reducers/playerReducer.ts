...
const playerSlice = createSlice({
  ...
  reducers: {
    ...
    moveBy: (state, action: PayloadAction<{ deltaX: number; deltaY: number }>) => {
    ...
    resizeBy: (state, action: PayloadAction<{ deltaWidth: number; deltaHeight: number }>) => {
    ...
    setPositionAndSize: (state, action: PayloadAction<{ position: Position; size: Size }>) => {
